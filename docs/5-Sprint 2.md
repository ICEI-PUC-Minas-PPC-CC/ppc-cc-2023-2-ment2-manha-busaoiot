...
ROTA:
A penúltima página, de rota,  mostra pelo mapa qual será a tragetória percorrida pelo ônibus, um alerta do valor da passagem e o horário de chegada no destino desejado pelo usuário.
<br><br>
...
FAVORITOS:
A última página é ativada quando o usuário seleciona a opção de favoritos na tela de busca, exibindo rapidamente os locais favoritos para agilizar o processo em comparação com a digitação do endereço desejado.
<br><br>
